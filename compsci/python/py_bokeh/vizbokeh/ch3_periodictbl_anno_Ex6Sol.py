...
output_file("nb/ch3/elements_annotations.html")
...
##add labels to spans
lbl_x_pos=80
label_span_gas_average_boil = Label(x=lbl_x_pos, y=gas_average_boil, text="Gas average boiling point", render_mode="css",
                                    text_font_size="10px")
label_span_liquid_average_boil = Label(x=lbl_x_pos, y=liquid_average_boil, text="Liquid average boiling point",
                                       render_mode="css",
                                       text_font_size="10px")
label_span_solid_average_boil = Label(x=lbl_x_pos, y=solid_average_boil, text="Solid average boiling point", render_mode="css",
                                      text_font_size="10px")
