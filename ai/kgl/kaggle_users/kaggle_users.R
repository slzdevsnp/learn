#rm(list=ls()); cdi<-getwd(); setwd('~/Dropbox/cs/bigdata/datacamp/statistical_modeling/'); source('kaggle_users.R') 

#rm(list=ls());  setwd("C:/Users/zimine/Dropbox/cs/bigdata/datacamp/kaggle_users"); source('kaggle_users.R') 

# Michal Wajszczuk 8 Jul 2015
...
for (i in 1:nPages) {
      ...
      print(paste("proccessing page:", i))
}
...
country <- subset(country, Freq>=5) # value 30
