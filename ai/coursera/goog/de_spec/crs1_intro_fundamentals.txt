...
chap Managed Hadoop in the cloud
    ...
    from Recommendation as r, Accommodation as a
     ...
     in gconsole:  to create a datalab vm
     > gcloud compute zones list
     > datalab create bdmlvm --zone us-central1-a
     console Preview Icon change port to 8081
     click on github icond

     navigate to python notebook
     training-data-analyst/CPB100/lab4a/demandforecast.ipynb

     ## this is new. call BigQuery from a notebook
    ...
    WHERE state = 'NY' AND wban != '99999' AND name LIKE '%LA GUARDI

     NB! bq syntax  explain
    _TABLE_SUFFIX = @YEAR

     the demandeforecast.ipynb is saved to ds course1 folder


     demo 6  invoking Google ML APIs 

     create again the datalab  vm 
     and checkout the usual data-analyst repo

     gcp: API & Services -> Library
       make sure  Vision, Translation, Speach, Natural Language APIs  are enables 
       API & Services -> Credentials 

       if necessary, create a credentials key
       d560e21b9cc1e59330c36489a9a335e8d8f24ad1 


       in datalab:   CPB100 > lab4c > mlapis.ipynb
       saved mlapis.ipynb  in  ds course1 folder



    chap serverless data pipelines : Google DataFlow
        Apache beam 
        can be executed on flink, spark
...
GCP in summary
    ...
    incorporate real-time data into apps
    apply machine learning broadly and easily
    create citizen data scientists ( gcp is putting tools into hands of domain experts)
...
google data engineeer track

c1 Google Cloud Platform Big Data and Machine Learning Fundamentals
c2 Leveraging Unstructured Data with Cloud Dataproc on Google Cloud Platform
c3 Serverless Data Analysis with Google BigQuery and Cloud Dataflow
c4 Serverless Machine Learning with Tensorflow on Google Cloud Platform
c5 Building Resilient Streaming Systems on Google Cloud Platform
